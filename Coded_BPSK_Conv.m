%Coded BPSK transmission in AWGN Using rate 1/2 convolutional code%
%Author Sidong Guo
clear;clc;close all;
...
Coded_bits=Convolutional_code(Bits,Block_Num);
...
nr=randn(1,n/Rate,Block_Num);
ni=randn(1,n/Rate,Block_Num);
...
for SNRdb=0:2:10
    ...
    Corrected_bits=Viterbi_correction(Coded_bits_r,Block_Num,n);     %Error correction, calling Viterbi_correction function
